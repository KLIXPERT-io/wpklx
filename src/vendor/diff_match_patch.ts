...
// @ts-nocheck
/**
 * Vendored from https://github.com/google/diff-match-patch
 * (javascript/diff_match_patch_uncompressed.js)
 *
 * Apache-2.0 licensed. Modifications: stripped Closure-specific tail exports
 * and replaced with ES module exports at the bottom of this file.
 *
...
// Minimal TypeScript types for the public API we use.
...
export type DiffMatchPatchCtor = new () => DiffMatchPatch;
